...
namespace Services
{
    public class AuthenticationManager : IAuthenticationService
    {
        ...
        public async Task<TokenDto> FormToken(bool populateExpiry)
        {
        ...
        //expire eden token'dan kullanıcı bilgilerini almak için bir token inşa edilir
        private ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            ...
            //token düzgün üretildi mi kontrol gerekli:
            var jwtSecurityToken = securityToken as JwtSecurityToken; //casting
        ...
        public async Task<TokenDto> RefreshToken(TokenDto tokenDto)
        {
            ...
            _user = user;
            return await FormToken(populateExpiry: false);
        }
    }
}
